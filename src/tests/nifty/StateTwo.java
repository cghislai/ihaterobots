 ...
 * @author charly
 */
public class StateTwo extends MyNiftyOverlayState implements ScreenController {
   ...
   private static final String STATE_NAME = "State 2";
   ...
   private void initNifty(final ScreenController controller) {
