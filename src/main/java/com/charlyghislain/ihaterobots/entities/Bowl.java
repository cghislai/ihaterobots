...
import com.charlyghislain.ihaterobots.entities.drawer.BowlDrawer;
import com.charlyghislain.ihaterobots.entities.controller.BowlController;
import com.charlyghislain.ihaterobots.entities.simulator.BowlSimulator;
 ...
 * @author charly
 */
public final class Bowl extends BaseEntity implements Entity, Drawable, Controllable, Updatable {

    private BowlController controller;
    private BowlSimulator simulator;
    private BowlDrawer drawer;

    public Bowl() {
        super();
        controller = new BowlController(this);
        simulator = new BowlSimulator(this);
        drawer = new BowlDrawer(this);
//        processAction(Action.DOWN, true); // always teleport
        width = 30;
        heigth = 30;
    }
    ...
    public BowlController getController() {
        return controller;
    }

    public BowlDrawer getDrawer() {
        return drawer;
    }

    public BowlSimulator getSimulator() {
        return simulator;
    }
