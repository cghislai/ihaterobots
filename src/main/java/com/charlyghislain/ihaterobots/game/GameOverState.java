...
public class GameOverState extends BasicGameState {
   private final static int TIMER_MAX = 10000;
   private final static String GAMEOVER_STRING = "Game Over";
   ...
   public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
      ...
      g.pushTransform();
      g.translate(container.getWidth() / 2 - 4 * stringWidth / 2,
                  posy - 4 * stringHeight / 2);
      g.pushTransform();
      g.scale(4f, 4f);
   ...
   public void enter(GameContainer container, StateBasedGame game) throws SlickException {
      ...
      // each state register the player if it needs it
