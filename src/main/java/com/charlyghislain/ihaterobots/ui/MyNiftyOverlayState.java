...
import com.charlyghislain.ihaterobots.ui.event.MouseEvent;
...
public abstract class MyNiftyOverlayState extends BasicGameState implements NiftyInputConsumer {
    ...
    public MyNiftyOverlayState() {
        ...
        lastMouseEvents = new MouseEvent[]{
                new MouseEvent(-1, -1, false, Input.MOUSE_LEFT_BUTTON, 0),
                new MouseEvent(-1, -1, false, Input.MOUSE_MIDDLE_BUTTON, 0),
                new MouseEvent(-1, -1, false, Input.MOUSE_RIGHT_BUTTON, 0)
        };
    }
    ...
    protected void initNifty() {
        ...
        initNifty(new BatchRenderDevice(LwjglBatchRenderBackendFactory.create()), new SlickSoundDevice());
    }
    ...
    public void gotoScreenIfNotActive(final String screenID) {
        ...
        if (currentScreen == null || currentScreen.getScreenId() == null || (screenID != null && !currentScreen.getScreenId().equals(screenID))) {
    ...
    public class OverlayInputSystem implements InputSystem {
        ...
        public void addMouseEvent(final int x, final int y, final int mouseWheel, final int button, final boolean buttonDown) {
            MouseEvent event = new MouseEvent(x, y, buttonDown, button, mouseWheel);
            synchronized (mouseEvents) {
